...
function showBoxRewardNotification(amount) {
  if (!boxNotfi) return;
  try {
    adsnotifi.textContent = `You get ${amount} coin`;
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        adsnotifi.style.opacity = "0.5";
      }, 2500);

      adsnotifi.style.transform = "translateY(-150%)";

      setTimeout(function () {
        adsnotifi.style.transform = "translateY(135px)";
      }, 100);

      setTimeout(function () {
        adsnotifi.style.transform = "translateY(-150%)";
        adsnotifi.style.opacity = "0";
      }, 3000);

      setTimeout(function () {
        adsnotifi.style.display = "none";
        adsnotifi.style.transform = "";
        adsnotifi.style.opacity = "";
      }, 3500);
    }, 400);
  } catch (e) {
